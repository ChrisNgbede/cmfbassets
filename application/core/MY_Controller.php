<?php
	...
	class MY_Controller extends CI_Controller
	{
		...
		function __construct()
		{
			...
			$this->imageType = array('gif', 'png', 'jpg', 'jpeg');
			$this->videoType = array('mp4', 'mov');
			$this->config->set_item('language', $language);
			$this->lang->load(array('site'), $language);
			$this->settings = $this->setting_model->getSettings();
			$this->currency = $this->settings->currency;
			$this->departments = [""=>"select department","marketing"=>"Marketing","consumer lending"=>"Consumer Lending","sme"=>"SME", "icu"=>"Internal Control", "operations"=>"Operations","ict"=>"ICT","credit"=>"Credit","legal"=>"Legal/Secretary","fincon"=>"FINCON"];
