        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <a class="btn btn-lg btn-success" href="<?php echo site_url('messaging/newtemplate'); ?>"> New
                        Template</a>
                </div>
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="catData" class="table table-striped  table-condensed table-hover"
                            style="margin-bottom:5px;">
                            <thead>
                                <tr class="warning">
                                    <td colspan="5" class="p0"><input type="text" class="form-control b0"
                                            name="search_table" id="search_table"
                                            placeholder="<?= lang('type_hit_enter'); ?>" style="width:100%;"></td>
                                </tr>
                                <tr class="success">
