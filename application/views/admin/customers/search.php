      ...
      <div class="container">
          <div class="row">
              <div class="col-md-8 mt-5">
                 <h5 class="mb-3">Search with phone number</h5>
                 <div class="input-group input-group-lg">
                  <input type="text" class="form-control" id="customerphone" placeholder="Enter phone number" value="<?php echo $phone ?>" <?php echo !empty($phone) ? 'readonly' : '' ;?>>
                  <span class="input-group-append">
                    <button type="button" class="btn btn-primary btn-flat" id="searchphone">Get Salary History</button>

                  </span>
                </div>
                <div id="loading-container" style="display:none">
                  <img src="<?php echo base_url().'assets/dist/img/Running dog.gif' ?>"> Searching remita. please wait...
                </div>
                    ...
                    <div class="col-md-12 mt-4">
                      <div class="result card mt-4 p-4" style="display: none;">
                         <div class="card-body">
                            ...
                            <a href="" class="btn btn-success btn-sm" id="createloan">Create Loan</a>
                         </div>
                          ...
                          <li class="item">
                            ...
                            <div class="product-info">
                              <a href="<?php echo base_url('admin/customers/salary_loan_details/'.$customer->phone) ?>" class="product-title"><?php echo $customer->fullname ?>
                                ...
                                <?php endif ?>
                                <small class="float-right"><?php echo formatDate(json_decode($customer_search->response)->responseDate) ?></small>
...
<!-- DataTables -->
<script>
   $("body").on("click","#searchphone",function(e){
      if ($('#customerphone').val() == ""){
          $(".val-msg").text('kindly input customer phone number first').addClass('text-danger');
      }else{
          $(".val-msg").text(""); 
          var d = new Date();   
          var phone = $('#customerphone').val(); 
          $("#createloan").attr('href',"<?php echo base_url('admin/customers/createloan?phone=')?>" + phone);
