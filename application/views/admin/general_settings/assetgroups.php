...
<div class="content-wrapper">
    ...
    <div class="card border-0 shadow-sm mt-3">
      <div class="card-header border-0 bg-transparent pt-4 px-4">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <h4 class="mb-0 font-weight-bold">Asset Groups</h4>
            <p class="text-muted mb-0 small">Organize categories into functional groups for refined tracking</p>
          </div>
          <div>
            <a href="<?= base_url('admin/general_settings/createassetgroup'); ?>" class="btn btn-primary shadow-sm"
  ...
  foreach ($groups as $group): ?>
            <tr>
              ...
              <td>
                <?= getbyid($group->cat_id, 'asset_categories')->name ?? 'N/A'; ?>
              </td>
              <td>
              ...
              <td class="text-right">
                <div class="btn-group">
                  <a href="<?= base_url('admin/general_settings/createassetgroup/' . $group->id); ?>"
                    data-toggle="ajax-modal" class="btn btn-light btn-sm text-primary" title="Edit">
                    <i class="fa fa-edit"></i>
                  </a>
                  <a href="<?= base_url('admin/general_settings/deleteassetgroup/' . $group->id); ?>"
