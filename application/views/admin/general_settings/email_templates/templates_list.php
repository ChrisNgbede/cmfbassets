	...
	<section class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-3">
						<table class="table table-hover templates-table text-center">
							<thead>
								<tr>
									<th>
										<?= trans('email_templates')?>
									</th>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
									<td class="btn-template-link cursor-pointer" data-type="<?= $row['id']?>">
										<span class="btn-template-link" data-type="<?= $row['id']?>">
											<?= $row['name']?>
										</span>
									</td>
								</tr>
									...
									<div class="form-group">
										<div class="col-12">
											...
											<input type="text" name="variables" class="form-control"
												placeholder="Template's Variables" disabled>
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-12">
											...
											<input type="button" value="<?= trans('preview')?>"
												class="btn btn-warning pull-right mr-1" id="btn_preview_email">
										</div>
									</div>
								</div>
							</div>
